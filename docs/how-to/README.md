...
| [Use OpenAI ChatGPT/Codex OAuth](use-openai-codex-oauth.md) | You want a native LLM agent to use a ChatGPT/Codex subscription through OAuth instead of an `OPENAI_API_KEY`. |
