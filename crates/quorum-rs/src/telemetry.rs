...
///
/// Emitted by any [`OutputLeakDetector`](crate::agents::OutputLeakDetector)
/// implementation: it reports that the guardrail saw one or more dictionary
/// hits on the agent's final response content, whether that tripped the retry
